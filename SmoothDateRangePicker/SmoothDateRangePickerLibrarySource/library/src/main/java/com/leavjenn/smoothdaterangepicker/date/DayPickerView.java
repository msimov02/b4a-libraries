...
public abstract class DayPickerView extends ListView implements OnScrollListener,
    ...
    public DayPickerView(Context context, SmoothDateRangePickerController controller) {
        super(context);
        init(context);
        setController(controller);
    }

    public void setController(SmoothDateRangePickerController controller) {
    ...
    public abstract MonthAdapter createMonthAdapter(Context context, SmoothDateRangePickerController controller);
    ...
    public boolean goTo(MonthAdapter.CalendarDay day, boolean animate, boolean setSelected, boolean forceScroll) {
        ...
        mTempDay.set(day);
        final int position = (day.year - mController.getMinSelectableYear()) * MonthAdapter.MONTHS_IN_YEAR + day.month;
    ...
    public boolean performAccessibilityAction(int action, Bundle arguments) {
        ...
        int year = firstVisiblePosition / 12 + mController.getMinSelectableYear();
